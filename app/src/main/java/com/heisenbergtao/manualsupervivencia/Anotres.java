...
public class Anotres extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.botonincludos:
                final AlertDialog.Builder builder = new AlertDialog.Builder(Anotres.this);
                final LayoutInflater inflater1 = getLayoutInflater();
                View vi = inflater1.inflate(R.layout.ano_tres_marcados, null);
                builder.setView(vi);
            ...
            case R.id.botoninclucuatro:
                final AlertDialog.Builder builder1 = new AlertDialog.Builder(Anotres.this);
                final LayoutInflater inflater11 = getLayoutInflater();
                View vi1 = inflater11.inflate(R.layout.ano_tres_marcacuatro, null);
            ...
            case R.id.botoninclunueve:
                final AlertDialog.Builder builder2 = new AlertDialog.Builder(Anotres.this);
                final LayoutInflater inflater12 = getLayoutInflater();
                View vi2 = inflater12.inflate(R.layout.ano_tres_marcanueve, null);
            ...
            case R.id.botonincluuno:
                final AlertDialog.Builder builder3 = new AlertDialog.Builder(Anotres.this);
                final LayoutInflater inflater13 = getLayoutInflater();
                View vi3 = inflater13.inflate(R.layout.ano_tres_marcauno, null);
            ...
            case R.id.botoninclucero:
                final AlertDialog.Builder builder4 = new AlertDialog.Builder(Anotres.this);
                final LayoutInflater inflater14 = getLayoutInflater();
                View vi4 = inflater14.inflate(R.layout.ano_tres_marcacero, null);
