...
public class SeguroFacultativo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seguro_facultativo);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.botonfamidirectosprimera:
                final AlertDialog.Builder builder = new AlertDialog.Builder(SeguroFacultativo.this);
            ...
            case R.id.botonfamidirectosrenova:
                ...
                final AlertDialog.Builder builders = new AlertDialog.Builder(SeguroFacultativo.this);
            ...
            case R.id.botonfamipoliticos:
                ...
                final AlertDialog.Builder builderss = new AlertDialog.Builder(SeguroFacultativo.this);
            ...
            case R.id.botongraficadirectos:
                ...
                final AlertDialog.Builder builderss1 = new AlertDialog.Builder(SeguroFacultativo.this);
            ...
            case R.id.botongraficapoliticos:
                ...
                final AlertDialog.Builder builderss12 = new AlertDialog.Builder(SeguroFacultativo.this);
