...
public class PliegoTestamentario extends AppCompatActivity implements View.OnClickListener {
...
private AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pliego_testamentario);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.botona:
                final AlertDialog.Builder builder = new AlertDialog.Builder(PliegoTestamentario.this);
            ...
            case R.id.botonb:
                ...
                final AlertDialog.Builder builders = new AlertDialog.Builder(PliegoTestamentario.this);
            ...
            case R.id.botonc:
                ...
                final AlertDialog.Builder builderss = new AlertDialog.Builder(PliegoTestamentario.this);
            ...
            case R.id.botonrequi:
                ...
                final AlertDialog.Builder builderss1 = new AlertDialog.Builder(PliegoTestamentario.this);
            ...
            case R.id.botontramite:
                ...
                final AlertDialog.Builder builderss12 = new AlertDialog.Builder(PliegoTestamentario.this);
